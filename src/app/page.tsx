...
//https://api.openweathermap.org/data/2.5/forecast?q=pune&appid=11d7fda6d9a17a7a1b5a277ab24c75eb
        ...
        {loadingCity ? ( 
          ...
          <section className="flex w-full flex-col gap-4">
            ...
            <ForecastWeatherDetail 
              ...
              sunrise={format(fromUnixTime(data?.city.sunrise ?? 1702517567), "H:mm")}
              sunset={format(fromUnixTime(data?.city.sunset ?? 1702517567), "H:mm")}
  ...
  return (
    <section className="space-y-8">
      ...
      <div className="space-y-2 animate-pulse">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gaps-4">
          {[1, 2, 3, 4].map((index) => (
